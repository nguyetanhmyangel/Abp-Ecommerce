...
[DependsOn(
    typeof(BasicEcommerceHttpApiModule),
...
public class BasicEcommerceAdminHttpApiHostModule : AbpModule
{
    ...
    {
        Configure<AbpDistributedCacheOptions>(options => { options.KeyPrefix = "BasicEcommerce:"; });
    }
    ...
    private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<BasicEcommerceDomainSharedModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}BasicEcommerce.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<BasicEcommerceDomainModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        app.UseAbpSwaggerUI(options =>
        {
            ...
            options.OAuthScopes("BasicEcommerce.Admin");
        });
