using BasicEcommerce.Inventories;
using BasicEcommerce.InventoryTickets;
using BasicEcommerce.Manufacturers;
using BasicEcommerce.Orders;
using BasicEcommerce.ProductAttributes;
using BasicEcommerce.ProductCategories;
using BasicEcommerce.Products;
using BasicEcommerce.Promotions;
...
public class BasicEcommerceDbContext :
    AbpDbContext<BasicEcommerceDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public BasicEcommerceDbContext(DbContextOptions<BasicEcommerceDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(BasicEcommerceConsts.DbTablePrefix + "YourEntities", BasicEcommerceConsts.DbSchema);
